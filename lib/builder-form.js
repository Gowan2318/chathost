...
export function composeBusinessInfo(form) {
  ...
  console.log("[builder-form] booking_url value:", form.bookingUrl, form.booking_url, form.booking_url || form.bookingUrl);
  if (bookingUrl) {
...
function composeIndustryInfo(form) {
  ...
  if (industry === "restaurant") {
    ...
    parts.push(form.acceptingNewPatients ? "We are currently accepting new patients" : "We are not currently accepting new patients — our schedule is full at this time");
