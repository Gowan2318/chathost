...
export function buildVoiceSystemPrompt(businessInfo) {
  ...
  return (
    ...
    `- Once you have all three, read them back clearly to confirm before ending that part of the call.\n\n` +
    `Taking a message:\n` +
    `- If the caller doesn't want to book, offer to take a message instead: their name, phone number, and the reason for the call.\n` +
    `- Read the message back to confirm before ending that part of the call.\n\n` +
